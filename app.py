...
def dashboard():
    ...
    jumlah_data = None
    kasus_tertinggi = None
    kasus_terendah = None
    bulan_tertinggi = None
    bulan_terendah = None
    rata_rata = None
    periode_tahun = None
    ...
    if df is not None:
        ...
        kasus_tertinggi = (
            f"{int(df.loc[idx_max, 'Jumlah Kasus'])} "
        )
        bulan_tertinggi = (
            f"{df.loc[idx_max, 'Bulan']} {int(df.loc[idx_max, 'Tahun'])}"
            )
        kasus_terendah = (
            f"{int(df.loc[idx_min, 'Jumlah Kasus'])} "
        )
        bulan_terendah = (
